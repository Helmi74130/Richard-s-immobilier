...
const HomeImg = () => {
  ...
  return (
    <>
      ...
      <div className='row'>
        <img className={`${styles.img} col-6`} src={img1} alt='Villa avec piscine'/>
        <AnimationOnScroll animateIn="animate__fadeInLeft" animateOnce={true} className='col-6 d-flex flex-column justify-content-center align-items-center'>
      ...
      <div className='container mt-5'>
        <div className='row'>
         <AnimationOnScroll animateIn="animate__fadeInRight" animateOnce={true} className='col-6 d-flex flex-column justify-content-center align-items-center'>
      ...
      <div className={`${styles.content} container mt-5`}>
        <div className={`${styles.block} row`}>
         ...
         <div className='col-7'>
          ...
          <AnimationOnScroll className="me-3 shadow" delay={500} animateOnce={true} animateIn="animate__fadeInRight"><img style={{height:"310px"}} src={img4} alt='Image rue de paris'/></AnimationOnScroll>
          <AnimationOnScroll className="me-3 shadow" delay={1000} animateOnce={true} animateIn="animate__fadeInRight"><img style={{height:"310px"}} src={img2} alt='Image villa avec piscine0'/></AnimationOnScroll>
          <AnimationOnScroll className="shadow" delay={1500} animateOnce={true} animateIn="animate__fadeInRight"><img style={{height:"310px"}} src={img3} alt='Rue de paris'/></AnimationOnScroll>
          </div>
         </div>
        </div>
      </div>
